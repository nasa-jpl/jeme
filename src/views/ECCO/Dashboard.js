  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <ModelInfoSection modelName="ECCO" modelDisplayName="ECCO" />
        ...
        {eccoData.length > 0 && eccoData[0]?.uncertainty && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <UncertaintyOverviewCard data={eccoData} />
            <UncertaintyMatrixCard data={eccoData} />
          </div>
        )}
        ...
        <div className="mb-6">
          <MissionsSummary citationsData={eccoData} maxMissions={8} showDetails={true} />
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          ...
          <GitHubMetricsCard owner="ECCO-GROUP" repo="ECCO-v4-Configurations" />
        </div>
