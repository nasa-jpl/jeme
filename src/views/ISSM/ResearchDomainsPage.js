...
const ISSMResearchDomainsPage = () => {
  ...
  const exportData = () => {
    ...
    link.setAttribute('download', 'issm_research_domains_analysis.csv');
      ...
      <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center">
            <Link to="/science-model-dashboard/ISSM" className="flex items-center text-blue-600 hover:text-blue-800 mr-6">
              <ArrowLeft size={18} className="mr-1" />
              <span className="font-medium">Back to ISSM Dashboard</span>
            </Link>
            <h1 className="text-xl font-semibold text-gray-900">ISSM Research Domains Analysis</h1>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
            ...
            <div className="flex flex-wrap items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Analysis of {citationsData.length} research papers using ISSM across different domains
                </p>
              </div>
            ...
            <div className="flex flex-wrap text-center mb-6">
              <div className="w-full sm:w-1/2 lg:w-1/5 p-3">
                <div className="bg-cyan-50 rounded-lg p-4">
                  <div className="text-3xl font-bold text-cyan-700 mb-1">{processedData.domains.length}</div>
                  <div className="text-sm text-cyan-600">Research Domains</div>
                </div>
              </div>
              <div className="w-full sm:w-1/2 lg:w-1/5 p-3">
              ...
              <div className="w-full sm:w-1/2 lg:w-1/5 p-3">
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="text-3xl font-bold text-blue-700 mb-1">
                    {processedData.domainStats['Environmental Science/Climate Change'] || 0}
                  </div>
                  <div className="text-sm text-blue-600">Climate Change</div>
                </div>
              </div>
              <div className="w-full sm:w-1/2 lg:w-1/5 p-3">
                <div className="bg-cyan-50 rounded-lg p-4">
                  <div className="text-3xl font-bold text-cyan-700 mb-1">
                    {processedData.domainStats['Oceanography/Climate Science'] || 0}
                  </div>
                  <div className="text-sm text-cyan-600">Ocean Science</div>
                </div>
              </div>
              <div className="w-full sm:w-1/2 lg:w-1/5 p-3">
              ...
              <div className="p-4 border-b border-gray-300">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-xs text-gray-500">
                    ...
                    {selectedDomain !== 'all' && (
                      <span className="ml-1 text-cyan-600 font-medium">({selectedDomain})</span>
                    )}
                  </div>
                </div>
              </div>
              <div className="p-4">
                        ...
                        return (
                          <div 
                            ...
                            className={`flex items-center space-x-2 p-2 rounded hover:bg-white transition-colors duration-200 cursor-pointer ${
                              isSelected ? 'bg-cyan-50 ring-2 ring-cyan-200' : ''
                            }`}
                            onClick={() => setSelectedDomain(domain.domain)}
                          >
                            <div 
                            ...
                            <div className="flex-1 min-w-0">
                              <div className={`text-xs font-medium truncate ${isSelected ? 'text-cyan-800' : 'text-gray-800'}`} title={domain.domain}>
                                {domain.domain}
                                {isSelected && <span className="ml-1 text-cyan-600">●</span>}
                              </div>
                              <div className="text-xs text-gray-500">
                ...
                <div className="pt-4 border-t border-gray-300">
                  <h5 className="text-xs font-medium text-gray-600 mb-3">
                    ...
                    {selectedDomain !== 'all' && (
                      <span className="text-cyan-600 font-medium ml-1">- {selectedDomain}</span>
                    )}
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mt-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            This analysis is based on {citationsData.length} research papers that cite or use the ISSM (Ice Sheet System Model) model. 
...
export default ISSMResearchDomainsPage;