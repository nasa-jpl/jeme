...
const CMSFluxDashboard = () => {
  ...
  useEffect(() => {
    const loadCmsFluxData = async () => {
      try {
        const cmsFluxModule = await import('../../data/CMS-Flux_analyzed.json');
        const data = cmsFluxModule.default || cmsFluxModule;
        setCmsFluxData(data);
      } catch (error) {
      ...
      <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-8">
            ...
            <a href="#" className="text-blue-600 border-b-2 border-blue-600 font-medium text-sm">CMS-Flux</a>
