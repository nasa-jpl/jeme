...
// Define consistent colors for domains (moved outside component for better accessibility)
const domainColors = ['#F59E0B', '#3B82F6', '#10B981', '#EF4444', '#8B5CF6', '#06B6D4', '#F97316', '#EC4899'];
                    ...
                    <div className="flex items-end justify-between h-24 px-2">
                      {yearData.slice(-12).map((year, index) => {
                        ...
                        const getDomainTimelineColor = () => {
                          if (selectedDomain === 'all') return 'bg-blue-600 hover:bg-blue-700';
                          
                          const colors = ['bg-blue-600 hover:bg-blue-700', 'bg-green-600 hover:bg-green-700', 'bg-purple-600 hover:bg-purple-700', 'bg-red-600 hover:bg-red-700', 'bg-cyan-600 hover:bg-cyan-700', 'bg-orange-600 hover:bg-orange-700', 'bg-pink-600 hover:bg-pink-700', 'bg-indigo-600 hover:bg-indigo-700'];
                          const domainIndex = topDomains.findIndex(d => d.domain === selectedDomain);
                          return domainIndex >= 0 && domainIndex < colors.length ? colors[domainIndex] : 'bg-gray-600 hover:bg-gray-700';
                        };
