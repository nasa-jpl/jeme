...
const EDMFDashboard = () => {
  ...
  // Load EDMF data for time series chart
  useEffect(() => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-8">
            ...
            <a href="#" className="text-blue-600 border-b-2 border-blue-600 font-medium text-sm">EDMF</a>
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
            ...
            {models.map((model, index) => (
              <Link
                ...
                className={`group p-4 border rounded-lg hover:border-blue-300 hover:shadow-md transition-all duration-200 ${
                  model.name === 'EDMF' ? 'border-blue-300 bg-blue-50' : 'border-gray-200'
                }`}
              >
                <div className="flex items-start gap-3">
                  <div className={`p-2 rounded-lg transition-colors ${
                    model.name === 'EDMF' ? 'bg-blue-100' : 'bg-gray-50 group-hover:bg-blue-50'
                  }`}>
                    {model.icon}
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className={`font-semibold transition-colors ${
                      model.name === 'EDMF' ? 'text-blue-900' : 'text-gray-900 group-hover:text-blue-900'
                    }`}>
                      {model.name}
                    </h3>
        ...
        <ModelInfoSection modelName="EDMF" modelDisplayName="EDMF" />
        <PaperInfo modelName="EDMF" />
        <Header modelName="EDMF" />
        ...
        <div className="bg-white rounded-lg p-5 shadow-sm mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Link
              to="/science-model-dashboard/EDMF/geographic-impact"
            ...
            <Link
              to="/science-model-dashboard/EDMF/research-domains"
        ...
        <div className="grid grid-cols-1 gap-6 mb-6">
          <JournalDistributionCard data={edmfData} />
        </div>
