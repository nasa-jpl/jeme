...
const GenericResearchDomainsPage = () => {
  ...
  const getDomainColor = (domain) => {
    const colors = {
      ...
      // ECCO domains
      "Ocean Circulation & Transport": "bg-blue-100 text-blue-800",
      "Sea Level Change & Variability": "bg-indigo-100 text-indigo-800",
      "Mesoscale & Submesoscale Dynamics": "bg-purple-100 text-purple-800",
      "Ocean Heat & Energy Budget": "bg-red-100 text-red-800",
      "Arctic & Polar Ocean": "bg-cyan-100 text-cyan-800",
      "Coastal & Regional Ocean": "bg-teal-100 text-teal-800",
      ...
      // EDMF domains
      "Boundary Layer Turbulence": "bg-blue-100 text-blue-800",
      "Convection & Cloud Processes": "bg-sky-100 text-sky-800",
      "Weather Prediction & NWP": "bg-indigo-100 text-indigo-800",
      "Air Quality & Pollution": "bg-orange-100 text-orange-800",
      "Aerosol & Radiation": "bg-amber-100 text-amber-800",
      "Tropical Cyclones & Storms": "bg-red-100 text-red-800",
      "Parameterization Development": "bg-purple-100 text-purple-800",
      "General Atmospheric Science": "bg-cyan-100 text-cyan-800",
      // ISSM domains
      ...
      // LES domains
      "Cloud & Stratocumulus Simulation": "bg-sky-100 text-sky-800",
      "Methane Detection & Plumes": "bg-amber-100 text-amber-800",
      "Fire & Smoke Modeling": "bg-red-100 text-red-800",
      "Atmospheric Chemistry LES": "bg-lime-100 text-lime-800",
      "Wind & Urban Applications": "bg-teal-100 text-teal-800",
      "Remote Sensing & AI Methods": "bg-indigo-100 text-indigo-800",
      // MOMO-CHEM domains
      ...
      // GRACE domains
      "Magnetic Field": "bg-purple-100 text-purple-800",
      "Atmosphere": "bg-orange-100 text-orange-800",
      "Solid Earth": "bg-amber-100 text-amber-800",
      "Processing/Algorithms": "bg-indigo-100 text-indigo-800",
      "Cryosphere": "bg-cyan-100 text-cyan-800",
      "Oceanography": "bg-blue-100 text-blue-800",
      "Geodesy": "bg-violet-100 text-violet-800",
      "Hydrology": "bg-teal-100 text-teal-800",
      "Other": "bg-gray-100 text-gray-700",
      // SWOT domains
      "River & Lake Monitoring": "bg-blue-100 text-blue-800",
      "Flood Mapping & Detection": "bg-red-100 text-red-800",
      "Ocean Surface Topography": "bg-indigo-100 text-indigo-800",
      "Coastal & Estuarine Dynamics": "bg-teal-100 text-teal-800",
      "Altimetry Methods & Calibration": "bg-purple-100 text-purple-800",
      ...
      "Cryosphere & Glaciology": "bg-cyan-100 text-cyan-800",
      "Remote Sensing & Satellite": "bg-indigo-100 text-indigo-800",
      "Ecosystem & Biogeochemistry": "bg-emerald-100 text-emerald-800",
      "Machine Learning & Data Science": "bg-violet-100 text-violet-800",
      "Modeling & Simulation": "bg-amber-100 text-amber-800",
      "Geophysics & Geodesy": "bg-purple-100 text-purple-800",
    };
