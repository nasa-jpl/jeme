      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-lg p-5 shadow-sm mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link
              to="/science-model-dashboard/TROPESS/citations"
            ...
            <Link
              to="/science-model-dashboard/TROPESS/geographic-impact"
            ...
            <Link
              to="/science-model-dashboard/TROPESS/research-domains"
            ...
            <Link
              to="/science-model-dashboard/TROPESS/uncertainty"
