...
const EngagementLevelsCard = () => {
  ...
  const getEngagementDescription = (level) => {
    const descriptions = {
      "Level 1: Data Usage": "Uses RAPID methodology, data, or outputs in their research",
      "Level 2: Model Adaptation": "Modifies, extends, or adapts the RAPID model for their needs",
      "Level 3: Foundational Method": "RAPID is foundational or central to their research methodology"
    };
  ...
  const calculateEngagementScore = () => {
    const weights = {
      "Level 1: Data Usage": 1,
      "Level 2: Model Adaptation": 2,
      "Level 3: Foundational Method": 3
    };
    ...
    <div className="bg-white rounded-lg p-5 shadow-sm h-full">
      ...
      <div className="h-64 mb-4">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={engagementData} layout="vertical" margin={{ top: 5, right: 30, left: 100, bottom: 5 }}>
            <CartesianGrid strokeDasharray="3 3" horizontal={true} vertical={false} />
            <XAxis type="number" tick={{ fontSize: 12 }} tickFormatter={(value) => value.toString()} />
            <YAxis type="category" dataKey="name" width={90} tick={{ fontSize: 11 }} />
            <Tooltip content={<CustomTooltip />} />
            <Bar dataKey="value" radius={[0, 4, 4, 0]} stroke="#ffffff" strokeWidth={1}>
        ...
        <div className="space-y-1 text-xs text-gray-600">
          ...
          <div className="flex justify-between py-1 border-b border-dashed border-gray-200">
            <div className="flex items-center">
              ...
              <span>Level 2: Model Adaptation</span>
            </div>
          ...
          <div className="flex justify-between py-1">
            <div className="flex items-center">
              ...
              <span>Level 3: Foundational Method</span>
            </div>
